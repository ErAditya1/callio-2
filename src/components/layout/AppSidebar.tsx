          ...
          <div className={cn("flex items-center gap-2", isCollapsed && "hidden")}>
            ...
            >
              ...
              <div className="flex items-center gap-1.5">
                <span className="font-bold text-sm tracking-tight text-foreground">Callio AI</span>
                <span className="text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded bg-indigo-500/15 text-indigo-400 border border-indigo-500/25">
                  Pro
                </span>
              </div>
            </Link>
