...
>(({ children, className, selected, invalid, selected_through_edge, hovered_through_edge, runtimeActive, ...props }, ref) => (
    <div
        ...
        className={cn(
            ...
            "relative rounded-lg border bg-[#FFFFFF] text-card-foreground min-w-[320px] max-w-[400px] min-h-[120px]",
            // Border styling
            "border-[#E5E5E5]",
            className,
            ...
            !selected_through_edge && !hovered_through_edge && "hover:border-[#E5E5E5]-foreground/50",
        )}
        tabIndex={0}
        {...props}
    >
