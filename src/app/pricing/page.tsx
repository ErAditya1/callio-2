  ...
  const PLANS = [
    {
      ...
      monthlyPrice: 49,
      annualPrice: 39,
      includedMinutes: '$49/mo Calling Credits (~800 mins)',
      overageRate: 'Dynamic at active model rates (from $0.06/min)',
      badge: null,
      popular: false,
      ctaText: 'Start 14-Day Free Trial',
      ctaHref: '/workflow',
      features: [
        '$49.00 USD monthly calling credits included',
    ...
    },
    {
      ...
      monthlyPrice: 199,
      annualPrice: 159,
      includedMinutes: '$160/mo Calling Credits (~2,600 mins)',
      overageRate: 'Dynamic at active model rates (from $0.06/min)',
      badge: 'Most Popular',
      popular: true,
      ctaText: 'Start 14-Day Free Trial',
      ctaHref: '/workflow',
      features: [
        '$160.00 USD monthly calling credits included',
    ...
    },
    {
      ...
      annualPrice: null,
      includedMinutes: 'Custom Contract Credits',
      overageRate: 'Dynamic tiered rates (from $0.04/min)',
      badge: 'High Scale',
      popular: false,
