// PARKED (2026-09-20): /overview control-room commented out per user request - not deleted.
// To restore: delete the redirect below and strip the leading // from the original.
// Live route redirects to /dashboard/overview so existing links never 404.
import { redirect } from "next/navigation";

export default function OverviewParkedRedirect() {
  redirect("/dashboard/overview");
}

// ---------------- PARKED ORIGINAL (commented, do not delete) ----------------
// "use client";
//
// import {
//   ArrowRight,
    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl space-y-8">
        ...
        <div className="group p-4 rounded-xl border border-border/60 bg-card/40 hover:bg-card/80 transition-all shadow-xs flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between text-muted-foreground mb-2">
              ...
              <div
                className={`p-1.5 rounded-lg transition-colors ${isWalletZero
            ...
            {loading ? (
              ...
              <div className="flex items-baseline gap-2">
                <span
                  className={`text-2xl font-bold tracking-tight ${isWalletZero
                      ? "text-rose-400"
                      : isWalletLow
                        ? "text-amber-400"
                        : "text-foreground"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                ...
                >
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge
                        variant="secondary"
                        className={`text-[10px] h-4.5 px-1.5 capitalize font-medium ${wf.status === "active"
        ...
        <div className="lg:col-span-5 space-y-6">
          {/* Quick Launchpad (Compact list without wall of text) */}
          <div className="space-y-3">
            <h2 className="text-base font-bold tracking-tight text-foreground flex items-center gap-2">
